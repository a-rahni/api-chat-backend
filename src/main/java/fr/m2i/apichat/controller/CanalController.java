...
import fr.m2i.apichat.exception.BadRequestException;
...
public class CanalController {
    ...
    public ResponseEntity<Object> getCanalById(@PathVariable("id") String id){
        try{
            ...
            throw new BadRequestException("The parameter "+ id+ " is not valid");
        }
    }
    ...
    public ResponseEntity<Object> addMessage(@PathVariable("idcanal") String idcanal,
        ...
        try {
            ...
            throw new BadRequestException("The parameter id or name is not valid");
        }
    }
